;(function () {
  ...
  function FastClick(layer, options) {
    ...
    layer.addEventListener('touchstart', this.onTouchStart, { passive: true })
    layer.addEventListener('touchmove', this.onTouchMove, { passive: true })
    layer.addEventListener('touchend', this.onTouchEnd, { passive: true })
    layer.addEventListener('touchcancel', this.onTouchCancel, { passive: true })
